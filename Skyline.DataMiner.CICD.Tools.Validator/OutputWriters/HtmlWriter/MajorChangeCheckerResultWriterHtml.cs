namespace Skyline.DataMiner.CICD.Tools.Validator.OutputWriters.HtmlWriter
{
    ...
    internal class MajorChangeCheckerResultWriterHtml : IMajorChangeCheckerResultWriter
    {
        ...
        public void WriteResults(MajorChangeCheckerResults mccResults)
        {
            ...
            stringBuilder.AppendFormat("{0}<footer>Generated by <a href=\"https://github.com/SkylineCommunications/Skyline.DataMiner.CICD.Validators\" target=\"_blank\">Skyline.DataMiner.CICD.Tools.Validator</a> v{1} at {2}.</footer>{0}</body>{0}</html>", Environment.NewLine, mccResults.ValidatorVersion, mccResults.ValidationTimeStamp);
